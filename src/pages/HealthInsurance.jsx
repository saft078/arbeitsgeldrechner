                    ...
                    results.map((item, index) => (
                        ...
                        >
                            ...
                            <div className="text-right min-w-[140px]">
                                ...
                                <button className="w-full text-sm font-semibold text-red-600 border border-red-100 bg-red-50 py-2 rounded-lg hover:bg-red-600 hover:text-white transition-colors">
                                    Offerte anfordern
                                </button>
                            </div>
                        </motion.div>
