...
const schema = {
    ...
    "@type": "WebApplication",
    "name": "SwissCheck Finanzrechner",
    "url": "https://arbeitsgeldrechner.ch",
    "description": "Kostenlose Schweizer Finanzrechner für Arbeitslosengeld, Krankenkasse, Kredit und Hypotheken.",
...
return (
    <div className="space-y-24 pb-20">
        <SEO
            title="Finanzrechner & Versicherungsvergleich"
            description="Der unabhängige Schweizer Vergleich. Berechnen Sie Arbeitslosengeld, Krankenkassenprämien, Kredite und Hypotheken. Kostenlos & Neutral."
            keywords="Finanzen Schweiz, Vergleich, Rechner, Arbeitslosengeld, Krankenkasse"
            schema={schema}
        />
        {/* Hero Section */}
